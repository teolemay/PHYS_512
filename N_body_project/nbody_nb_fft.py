...
parts=particles(npart=1000000,soft=2,periodic=True)

#parts.ics_gauss()
#parts.ics_poisson()
#parts.ics_powlaw(ind=-2)
# parts.ics_2gauss()1000000, 2
parts.x = np.random.randn(1000000, 2)*(1000//6) + 1000//2
parts.v = np.zeros((1000000, 2))

parts.m = np.ones(1000000)
parts.get_kernel()
